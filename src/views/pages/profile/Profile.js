...
const getUploadSignature = async () => {
  const res = await api.get('https://babycloud.netlify.app/api/upload/cloudinary-signature');
  return res.data;
};
    ...
    const loadUser = async () => {
      try {
        const res = await api.get(
          'https://babycloud.netlify.app/api/users/me',
    ...
    try {
      ...
      if (formData.photo) {
        try {
          ...
          await api.put(
            'https://babycloud.netlify.app/api/users/profile-image',
            {
